...
export default class LayerSwitcher extends Control {
     ...
     */
    static renderPanel(map: Map, panel: HTMLElement, options: RenderOptions): void;
    /**
     * **_[static]_** - Determine if a given layer group contains base layers
     * @param grp Group to test
     */
    static isBaseGroup(grp: LayerGroup): boolean;
    protected static setGroupVisibility(map: Map): void;
    protected static setChildVisibility(map: Map): void;
    /**
     ...
     * @protected
     */
    protected static ensureTopVisibleBaseLayerShown(map: Map, groupSelectStyle: GroupSelectStyle): void;
    /**
     ...
     */
    static getGroupsAndLayers(grp: Map | LayerGroup, filterFn: (lyr: BaseLayer, idx: number, arr: BaseLayer[]) => boolean): BaseLayer[];
    /**
     ...
     * @protected
     */
    protected static setVisible_(map: Map, lyr: BaseLayer, visible: boolean, groupSelectStyle: GroupSelectStyle): void;
    /**
     ...
     * @protected
     */
    protected static renderLayer_(map: Map, lyr: BaseLayer, idx: number, options: RenderOptions, render: (changedLyr: BaseLayer) => void): HTMLElement;
    /**
     * Render all layers that are children of a group.
     * @param map The map instance.
     ...
     * @protected
     */
    protected static renderLayers_(map: Map, lyr: Map | LayerGroup, elm: HTMLElement, options: RenderOptions, render: (changedLyr: BaseLayer) => void): void;
    /**
     ...
     * found under `lyr`.
     */
    static forEachRecursive(lyr: Map | LayerGroup, fn: (lyr: BaseLayer, idx: number, arr: BaseLayer[]) => void): void;
    /**

...
export default class LayerSwitcher extends Control {
     ...
     */
    static renderPanel(map: any, panel: any, options: any): void;
    static isBaseGroup(lyr: any): boolean;
    static setGroupVisibility(map: any): void;
    static setChildVisibility(map: any): void;
    /**
     * **Static** Ensure only the top-most base layer is visible if more than one is visible.
     * @param {ol/Map~Map} map The map instance.
     * @private
     */
    static ensureTopVisibleBaseLayerShown_(map: any, groupSelectStyle: any): void;
    static getGroupsAndLayers(lyr: any, filterFn: any): any[];
    /**
     ...
     *   `'group'` groups have a checkbox but do not alter child visibility (like QGIS).
     */
    static setVisible_(map: any, lyr: any, visible: any, groupSelectStyle: any): void;
    /**
     ...
     */
    static renderLayer_(map: any, lyr: any, idx: any, options: any, render: any): HTMLLIElement;
    /**
     * **Static** Render all layers that are children of a group.
     * @private
     * @param {ol/Map~Map} map The map instance.
     ...
     * @param {Function} render Callback for change event on layer
     */
    static renderLayers_(map: any, lyr: any, elm: any, options: any, render: any): void;
    /**
     ...
     */
    static forEachRecursive(lyr: any, fn: any): void;
    /**
     ...
     */
    static enableTouchScroll_(elm: any): void;
    /**
     * @private
     ...
     */
    static toggleFold_(lyr: any, li: any): void;
    /**
     ...
     */
    static getGroupSelectStyle(groupSelectStyle: any): any;
}
